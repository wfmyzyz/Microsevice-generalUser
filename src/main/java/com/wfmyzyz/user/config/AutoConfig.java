...
public class AutoConfig {
    ...
    * 数据库配置
    */
    public static final String DATA_URL = "jdbc:mysql://localhost:3306/microservice-user?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC&allowMultiQueries=true&zeroDateTimeBehavior=convertToNull";
